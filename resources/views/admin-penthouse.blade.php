...
<div class="content">
    <div class="mt-4">
        ...
        <div class="card">
            <h5 class="card-header"><span data-feather="home" class="me-2"></span>Penthouse</h5>
            <div class="row g-0">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h4 class="mt-4 mb-3 text-800">Penthouse</h4>
                        ...
                        <table class="table table-bordered border-primary">
                            ...
                            <tbody>
                                <tr>
                                    <th>Penthouse is atop the Club House with a view to the far away mountains. The
                                        wooden stairs with customized woodworks takes you to this beautiful space. The
                                        spacious room with long glass windows all around gives a bird's eye view of the
                                        beautiful resort and the green hills. The air- conditioned bedroom with a 12
                                        inch mattress has a 50 inch TV, a minibar and a wardrobe with digital locker.
                                    </th>
                                    <td>11500</td>
                                    <td>1750</td>
