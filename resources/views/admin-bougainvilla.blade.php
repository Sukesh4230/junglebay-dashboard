...
<div class="content">
    <div class="mt-4">
        ...
        <div class="card">
            <h5 class="card-header"><span data-feather="home" class="me-2"></span>Bougain Villa</h5>
            <div class="row g-0">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h4 class="mt-4 mb-3 text-800">Bougain Villa</h4>
                        ...
                        <table class="table table-bordered border-primary">
                            ...
                            <tbody>
                                <tr>
                                    <th>Bougain Villas are Jungle Bay's identity. The twin Villas with spacious rooms
                                        and wide open balconies facing the jungle is a special place. The 600 square
                                        feet air conditioned villa has bedroom with a 12 inch mattress, a 50 inch TV, a
                                        minibar and a wardrobe with digital locker. The long glass windows open to the
                                        east welcoming the sunrise. Watch the jungles from the deck overhearing the
                                        murmurs of a brook. Beautifully done beds, cosy linen and the aesthetics in each
                                        corner of the villa will impress you.</th>
                                    <td>10000</td>
                                    <td>1750</td>
    ...
    <footer class="footer position-absolute">
        <div class="row g-0 justify-content-between align-items-center h-100">
            <div class="col-12 col-sm-auto text-center">
                <p class="mb-0 mt-2 mt-sm-0 text-900"> <a href="" target="_blank">www.junglebayresorts.com</a> All
                    rights Reserved
