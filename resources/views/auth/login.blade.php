                    ...
                    <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3">
                        <a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
                            <div class="d-flex align-items-center fw-bolder fs-5 d-inline-block">
                                <img src="../../../img/logo.png" alt="phoenix" width="250" />
                            </div>
                        </a>
                        <div class="text-center mb-7">
                            <h3 class="text-1000">Junglebay Admin Dashboard</h3>
                            <p class="text-700">Get access to your Dashboard</p>
                        </div>

                        <div class="position-relative">
                            <hr class="bg-200 mt-5 mb-4" />
                            <div class="divider-content-center">Junglebay Login</div>
                        </div>
