...
<div class="content">
    <div class="mt-4">
        ...
        <div class="card">
            <h5 class="card-header"><span data-feather="home" class="me-2"></span>Regal Jacuzzi Villa</h5>
            <div class="row g-0">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h4 class="mt-4 mb-3 text-800">Regal Jacuzzi Villa</h4>
                        ...
                        <table class="table table-bordered border-primary">
                            ...
                            <tbody>
                                <tr>
                                    <th>Get pampered in our cozy couple jacuzzis here. The jaguar branded jacuzzi is
                                        just one of the factors giving that wow feel. Watch the early sunrise through
                                        the long french windows from the warmth of your luxury bed. There's a spacious
                                        deck on the east with a peek to the plantations and the far away jungle. Listen
                                        to the murmurs of a nearby brook while you unwind. The air-conditioned bedroom
                                        with a 12 inch mattress has a 50 inch TV, a minibar and a wardrobe with digital
                                        locker.</th>
                                    <td>14000</td>
                                    <td>1750</td>
