...
<div class="content">
    <div class="mt-4">
        ...
        <div class="card">
            <h5 class="card-header"><span data-feather="home" class="me-2"></span>Pavilion Room</h5>
            <div class="row g-0">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h4 class="mt-4 mb-3 text-800">Pavilion Room</h4>
                        ...
                        <table class="table table-bordered border-primary">
                            ...
                            <tbody>
                                <tr>
                                    <th>The pavilions rooms with the juliette balconies face the plantations on one side
                                        and opens to the vast lawn on the other. Beautifully painted coloured walls and
                                        the cosy sofas gives a soothing effect. The room with a 10 inch mattress has a
                                        43 inch TV, a mini bar and a wardrobe with digilocker. The resort amenities
                                        including the spa, the conference room, gym and the activity area are housed in
                                        the Pavilion itself and hence easily accessible to the guests here too.</th>
                                    <td>8000</td>
                                    <td>1750</td>
