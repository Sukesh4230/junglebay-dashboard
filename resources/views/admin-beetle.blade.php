...
<div class="content">
    <div class="mt-4">
        ...
        <div class="card">
            <h5 class="card-header"><span data-feather="home" class="me-2"></span>Beetle – The Tree House</h5>
            <div class="row g-0">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h4 class="mt-4 mb-3 text-800">Beetle – The Tree House</h4>
                        ...
                        <table class="table table-bordered border-primary">
                            ...
                            <tbody>
                                <tr>
                                    <th>Hoisted along a Rosewood and Jackfruit tree is this tall Tree House spanning across 400 square feet. The thatched roof and the elevated stance with an aerial view adds to the feel. A private dinner on the spacious deck with a view to the jungle will be a memorable experience here. The premium wooden interiors and the cot with a unique design gives it a special aura. The air-conditioned bedroom has a huge TV, mini bar and a dressing room with a wardrobe and locker facility. The plush bathroom has the most modern and branded sanitary wares.</th>
                                    <td>15000</td>
                                    <td>1750</td>
